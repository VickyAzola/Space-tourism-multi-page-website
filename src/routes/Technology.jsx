...
function Technology() {
    ...
    return (
        ...
        <div className='technology'>
            ...
            <main className='max-w-[80rem] mx-auto pb-[2rem] md:pb-[4rem] grid min-h-screen pt-[20%] lg:pt-[12%] '>
                <h1           
                    className='text-white text-center md:text-left barlow-CondensedFont md:pl-8 lg:pl-14 
